...
//this is getting the forecast information
let getCityForecast = function(city){
    let apiKey = "af21e0e9978bb3a47d8af4f3f7fb7f88"
...
//1 create base element.  2 give that element information  3. append it to html
...
//    if(city){
//        getCityWeather(city);
//        getCityForecsat(city);
//    }
// }
// pastSearch();
// getCityWeather(cities[cities.length-1]);
// getCityForecast(cities[cities.length-1]);
